...
scaffolded directly into `.loop/` by `loop.py init`, so they are
...
|---|---|---|
| `task.md` | Architect | `.loop/2-build/tasks/TASK-###.md` |
| `report.md` | Worker | `.loop/2-build/reports/TASK-###.report.md` |
| `qa-report.md` | Tester | `.loop/3-verify/qa/QA-###.md` |
| `verdict.md` | Judge | `.loop/3-verify/verdicts/V-###.md` |
| `rework.md` | Judge | `.loop/3-verify/rework/R-###.md` |
