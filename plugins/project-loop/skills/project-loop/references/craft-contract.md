...
One file, `.loop/1-spec/conventions.md`, in every Worker's read-set. The Architect writes sections
...
`.loop/1-spec/qa-strategy.md` which craft rules are blocking for this project. Sensible default:
